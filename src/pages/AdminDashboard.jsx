...
const AdminDashboard = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-yellow-600/10 rounded-full blur-[120px] pointer-events-none"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <div className="flex items-center space-x-6">
                            <span className="text-yellow-300 font-medium hidden sm:block">Administrator</span>
                            <button
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
                    ...
                    <div className="flex items-center glass-card p-3 px-5 neon-border">
                        <label className="mr-3 font-medium text-yellow-300 text-base">Filter by Date:</label>
                        <input
                            type="date"
                            value={filterDate}
