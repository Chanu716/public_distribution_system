...
const AdminDashboard = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-cyan-600/10 rounded-full blur-[120px] pointer-events-none"></div>

            <nav className="glass sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16 items-center">
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-cyan-400 to-blue-600 flex items-center justify-center shadow-react-glow-sm">
                            ...
                            <h1 className="text-2xl font-bold text-white drop-shadow-md tracking-wide">
                                Admin<span className="text-react-blue">Portal</span>
                            </h1>
                        </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                        <span className="text-react-blue">●</span> All Bookings
                    </h2>

                    <div className="flex items-center glass-card p-2 px-4 neon-border">
                        <label className="mr-3 font-medium text-gray-300 text-sm">Filter by Date:</label>
                        <input
                            type="date"
                            value={filterDate}
